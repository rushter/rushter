...
- [MLAlgorithms](https://github.com/rushter/MLAlgorithms) — Minimal and clean examples of machine learning algorithms implementations **(★ 10,917)**
- [data-science-blogs](https://github.com/rushter/data-science-blogs) — A curated list of data science blogs **(★ 6,374)**
- [selectolax](https://github.com/rushter/selectolax) — Python binding to Modest and Lexbor engines. Fast HTML5 parser with CSS selectors for Python. **(★ 1,447)**
...
- [hexora](https://github.com/rushter/hexora) — Static analysis of malicious Python code **(★ 74)**
