...
- [MLAlgorithms](https://github.com/rushter/MLAlgorithms) — Minimal and clean examples of machine learning algorithms implementations **(★ 10,918)**
- [data-science-blogs](https://github.com/rushter/data-science-blogs) — A curated list of data science blogs **(★ 6,377)**
- [selectolax](https://github.com/rushter/selectolax) — Python binding to Modest and Lexbor engines. Fast HTML5 parser with CSS selectors for Python. **(★ 1,448)**
...
- [hexora](https://github.com/rushter/hexora) — Static analysis of malicious Python code **(★ 76)**
