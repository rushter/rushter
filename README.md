...
- [MLAlgorithms](https://github.com/rushter/MLAlgorithms) — Minimal and clean examples of machine learning algorithms implementations **(★ 10,903)**
- [data-science-blogs](https://github.com/rushter/data-science-blogs) — A curated list of data science blogs **(★ 6,372)**
- [selectolax](https://github.com/rushter/selectolax) — Python binding to Modest and Lexbor engines. Fast HTML5 parser with CSS selectors. **(★ 1,426)**
...
- [hexora](https://github.com/rushter/hexora) — Static analysis of malicious Python code **(★ 44)**
