...
- [selectolax](https://github.com/rushter/selectolax) — Python binding to Modest and Lexbor engines (fast HTML5 parser with CSS selectors). **(★ 1,408)**
...
- [hexora](https://github.com/rushter/hexora) — Static analysis of malicious Python code **(★ 14)**
